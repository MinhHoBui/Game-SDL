...
bool loadMedia()
{
    ...
    //load press to play texture
    if ( !gPlayTexture.loadFromFile ( "assets/Menu/start.png" ) )
    {
    ...
    //load space texture
    if ( !gSpaceTexture.loadFromFile ( "assets/Button/space.png" ) )
    {
    ...
    //load escape texture
    if ( !gSkeyTexture.loadFromFile ( "assets/Button/sKey.png" ) )
    {
        cout << "Unable to load s key texture!" << endl;
        success = false;
    }
    else
    {
        for ( int i = 0 ; i < TOTAL_BUTTON ; i++ )
        {
            gSkeyClips[ i ] = { i * 50 , 0 , 50 , 50 };
        }
    }

    //load i key texture
    if ( !gIkeyTexture.loadFromFile ( "assets/Button/iKey.png" ) )
    {
        cout << "Unable to load i key texture!" << endl;
        success = false;
    }
    else
    {
    ...
    //load fonts
    gFont = TTF_OpenFont ( "assets/Font/DungeonFont.ttf" , 28 );
    if ( gFont == nullptr )
    {
...
void handleMenuButton ( SDL_Event e , LTexture& gInstructionTexture , Button& spaceButton , Button& sButton , Button& iButton , Button& escButton ,
                       Mix_Chunk* gPress , Mix_Chunk* gJump , Mix_Music* gInstructionMusic ,
                       bool& menu , bool& play , bool &quit )
{
    if ( e.type == SDL_KEYDOWN && e.key.repeat == 0 )
    {
        ...
        case SDLK_i:
            {
                iButton.currentSprite = BUTTON_PRESSED;
    ...
    if ( e.type == SDL_KEYUP && e.key.repeat == 0 )
    {
        ...
        case SDLK_i:
            {
                iButton.currentSprite = BUTTON_NOT_PRESSED;
                ...
                while ( instruction )
                {
                    ...
                    while ( SDL_PollEvent ( &e ) != 0 )
                    {
                        ...
                        else if ( e.type == SDL_KEYDOWN && e.key.repeat == 0 )
                        {
                            ...
                            {
                            case SDLK_SPACE:
                                spaceButton.currentSprite = BUTTON_PRESSED;
                                break;
                            case SDLK_s:
                                sButton.currentSprite = BUTTON_PRESSED;
                                break;
                            case SDLK_ESCAPE:
                        ...
                        else if ( e.type == SDL_KEYUP && e.key.repeat == 0 )
                        {
                            ...
                            {
                            case SDLK_SPACE:
                                spaceButton.currentSprite = BUTTON_NOT_PRESSED;
                                break;
                            case SDLK_s:
                                sButton.currentSprite = BUTTON_NOT_PRESSED;
                                break;
                            case SDLK_ESCAPE:
                    ...
                    //render buttons
                    spaceButton.render ( &gSpaceClips[ spaceButton.currentSprite ] , gSpaceTexture );
                    sButton.render ( &gSkeyClips[ sButton.currentSprite ] , gSkeyTexture );
...
{
    gYourScoreTextTexture.render ( 925 , 15 );
